        ...
        <>
            <div className="container-home-page">
                <div className="text-zone" style={{ textAlign: 'center' }}>
                    ...
                    <Link to="/teams" className="flat-button" style={{margin: '10px', fontSize: '18px', font: 'caption', color: '#ffffffff' }}>Pitchers</Link>
                    <Link to="/teams" className="flat-button" style={{margin: '10px', fontSize: '18px', font: 'caption', color: '#ffffffff' }}>Batters</Link>
                </div>
            </div>
            <Loadert type="pacman" />
        </>
